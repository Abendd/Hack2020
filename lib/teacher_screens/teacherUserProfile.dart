...
class TeacherUserProfile extends StatefulWidget {
  ...
  @override
  _TeacherUserProfileState createState() => _TeacherUserProfileState();
}

class _TeacherUserProfileState extends State<TeacherUserProfile> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: timetablePath=="NotAvailable"?Center(child: CircularProgressIndicator(),):  SingleChildScrollView(
        child: Column(
          children: <Widget>[
            SizedBox(
              height: h / 30,
                  ...
                  RaisedButton(
                    ...
                    onPressed: () async {
                     ...
                     if (newName == "" && newClass == "" && newSection == "") {
                        Flushbar(
                          title: "Note",
                          message: "No Teacher info changed ",
                          duration: Duration(seconds: 3),
                          margin: EdgeInsets.all(8),
                          borderRadius: 8,
                        )..show(context).whenComplete(() {
